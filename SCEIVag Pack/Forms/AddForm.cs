...
namespace SCEIVag_Pack.Forms
{
    public partial class AddForm : Form
    {
        ...
        private void add_bt_Click(object sender, EventArgs e)
        {
            ...
            {
                case Type_Add.DuplicateEntry:
                    IECS.Prog.Entry cloneEntry = MainForm.sceifile._Program.Entries[MainForm.sceifile._Program.Entries.Count() - 1].Clone();
                    cloneEntry.Extents[0].SSetIndex = (ushort)MainForm.sceifile._SampleSets.SampleSets.Count();
                    MainForm.sceifile._Program.Add(cloneEntry);

                    IECS.Sset.SampleSet cloneSSet = MainForm.sceifile._SampleSets.SampleSets[MainForm.sceifile._SampleSets.SampleSets.Count() - 1].Clone();
                    cloneSSet.SampleID = (ushort)MainForm.sceifile._Samples.VAG_Samples.Count();
                    MainForm.sceifile._SampleSets.Add(cloneSSet);

                    IECS.VagSamples.Sample cloneSample = MainForm.sceifile._Samples.VAG_Samples[MainForm.sceifile._Samples.VAG_Samples.Count() - 1].Clone();
                    cloneSample.VAG_Id = (ushort)MainForm.sceifile._Infos.VAG_Infos.Count();
                    MainForm.sceifile._Samples.Add(cloneSample);

                    IECS.VAGInfo.Information cloneVAGInfo = MainForm.sceifile._Infos.VAG_Infos[MainForm.sceifile._Infos.VAG_Infos.Count() - 1].Clone();
                    MainForm.sceifile._Infos.Add(cloneVAGInfo);
                ...
                case Type_Add.EditEntry:
                    Entry ent = add_box.SelectedObject as Entry;
                    MessageBox.Show("Entry edited!");
                    break;

                case Type_Add.DuplicateSampleSet:
                    DuplicateSSet duplicateSSet = add_box.SelectedObject as DuplicateSSet;
                    MainForm.sceifile._SampleSets.Add(duplicateSSet.ChoosedEntry.Clone());
                    MessageBox.Show("Entry added!");
                    break;

                case Type_Add.EditSset:
                    DuplicateSSet edSampleSet = add_box.SelectedObject as DuplicateSSet;
                    MessageBox.Show("Entry edited!");
                    break;

                case Type_Add.DuplicateSample:
                    DuplicateSample duplicateSample = add_box.SelectedObject as DuplicateSample;
                    MainForm.sceifile._Samples.Add(duplicateSample.ChoosedEntry.Clone());
                    MessageBox.Show("Entry added!");
                    break;
                case Type_Add.EditSample:
                    DuplicateSample edSample = add_box.SelectedObject as DuplicateSample;
                    MessageBox.Show("Entry edited!");
                    break;
                case Type_Add.EditVAG:
                    VAG_Info vag = add_box.SelectedObject as VAG_Info;
                    MessageBox.Show("Entry edited!");
                    break;
                case Type_Add.DuplicateVag:
                    VAG_Info dupvag = add_box.SelectedObject as VAG_Info;
                    MainForm.sceifile._Infos.Add(dupvag.ChoosedEntry.Clone());
                    MessageBox.Show("Entry added!");
                    break;
                default:                   
                    break;
